...
final class ForgeOriginalVoxyRenderResourceReuse {
    ...
    private ForgeOriginalVoxyRenderResourceReuse() {
    }
    ...
    static ReusedGeometryBuffer getOrCreateGeometryBuffer() {
        ...
        long capacityBytes = ForgeOriginalVoxyBasicSectionGeometryData.selectGeometryCapacityBytes();
        ForgeOriginalVoxyBasicSectionGeometryData.GeometryAllocation allocation =
                ForgeOriginalVoxyBasicSectionGeometryData.createGeometryBuffer(capacityBytes);
        VoxyForge.LOGGER.info(
