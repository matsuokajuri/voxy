...
final class ForgeOriginalVoxyFragmentedStorageBackendAdaptor extends StorageBackend {
    private final StorageBackend[] backends;

    ForgeOriginalVoxyFragmentedStorageBackendAdaptor(StorageBackend... backends) {
