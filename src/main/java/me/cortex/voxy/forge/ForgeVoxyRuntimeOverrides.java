...
public final class ForgeVoxyRuntimeOverrides {
    ...
    public static synchronized void applyFormalTerrainRecordBridgePreset() {
        clearInternal();
        presetName = "formal_terrain_record_bridge";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalTerrainRendererOwnerNoDrawPreset() {
        clearInternal();
        presetName = "formal_terrain_renderer_owner_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalMdicViewportOwnerNoDrawPreset() {
        clearInternal();
        presetName = "formal_mdic_viewport_owner_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalCommandGenerationOwnerNoDrawPreset() {
        clearInternal();
        presetName = "formal_command_generation_owner_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalVisibilityOwnerNoDrawPreset() {
        clearInternal();
        presetName = "formal_visibility_owner_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalCmdgenGpuValidationNoDrawPreset() {
        clearInternal();
        presetName = "formal_cmdgen_gpu_validation_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalCmdgenRealSectionDryRunNoDrawPreset() {
        clearInternal();
        presetName = "formal_cmdgen_real_section_dry_run_no_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalModelIdGeometryPathNoLiveDrawPreset() {
        clearInternal();
        presetName = "formal_model_id_geometry_path_no_live_draw";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
    ...
    public static synchronized void applyFormalVisibleLodPreviewDebugPreset() {
        clearInternal();
        presetName = "formal_visible_lod_preview_debug";
        enableWorldEngineSkeleton = true;
        enableAutoChunkIngest = false;
        enableAutoCpuMeshBuild = false;
        enableAutoBuiltSectionBuild = false;
