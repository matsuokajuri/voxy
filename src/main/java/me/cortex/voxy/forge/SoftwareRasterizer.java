...
final class SoftwareRasterizer {
    ...
    /*
     * Forge bakes model textures with this software rasterizer. Testing the two
     * triangles independently makes their shared diagonal a coverage boundary;
     * transformed float coordinates can then leave a pixel outside both halves.
     * Test the four outer quad edges once and use the triangle split only for
     * barycentric interpolation, matching the watertight XVI runtime fix.
     */
