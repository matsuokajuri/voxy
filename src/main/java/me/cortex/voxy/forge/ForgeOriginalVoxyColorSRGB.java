...
/**
 * Forge-local port of Embeddium/Sodium's fast-srgb8 ColorSRGB helper used by
 * original Voxy TextureUtils.
 * Upstream fast-srgb8 source is MIT/Apache-2.0 licensed.
 */
final class ForgeOriginalVoxyColorSRGB {
    ...
    private ForgeOriginalVoxyColorSRGB() {
    }
    ...
    static int linearToSrgb(float r, float g, float b, int a) {
        return FastColor.ABGR32.color(a, linearToSrgb8(b), linearToSrgb8(g), linearToSrgb8(r));
    }
