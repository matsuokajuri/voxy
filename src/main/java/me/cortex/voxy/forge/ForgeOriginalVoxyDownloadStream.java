...
final class ForgeOriginalVoxyDownloadStream {
    private static final long DEFAULT_SIZE = 1L << 25;
    private static ForgeOriginalVoxyDownloadStream instance;
    ...
    private ForgeOriginalVoxyDownloadStream(long size) {
    ...
    static ForgeOriginalVoxyDownloadStream instance() {
        if (instance == null) {
            instance = new ForgeOriginalVoxyDownloadStream(DEFAULT_SIZE);
        }
        return instance;
    }
