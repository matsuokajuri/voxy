...
final class ForgeOriginalVoxyRingTracker {
    ...
    ForgeOriginalVoxyRingTracker(int radius, int centerX, int centerZ, boolean fill) {
        this(null, radius, centerX, centerZ, fill);
    }

    ForgeOriginalVoxyRingTracker(ForgeOriginalVoxyRingTracker stealFrom, int radius, int centerX, int centerZ, boolean fill) {
