...
final class ForgeVoxyParityCommands {
    ...
    private static String format(ForgeOriginalVoxyModelPipelineStats status) {
        ...
        return "Voxy original model pipeline parity: "
                ...
                + " deprecatedPreviewRouteAbsent=" + status.deprecatedPreviewRouteAbsent()
                + " deprecatedModelSampleRouteAbsent=" + status.deprecatedModelSampleRouteAbsent()
                ...
                + " originalOculusShaderpackPipelineActive=" + visible.originalOculusShaderpackPipelineActive()
                + " originalOculusShaderpackPipelineDataReady=" + visible.originalOculusShaderpackPipelineDataReady()
                + " originalOculusShaderpackPatchShaderUsed=" + visible.originalOculusShaderpackPatchShaderUsed()
                + " originalOculusShaderpackBindingsUsed=" + visible.originalOculusShaderpackBindingsUsed()
                + " originalOculusShaderpackDrawTargetsUsed=" + visible.originalOculusShaderpackDrawTargetsUsed()
                + " originalOculusShaderpackUniformsUsed=" + visible.originalOculusShaderpackUniformsUsed()
                + " originalOculusShaderpackSsboBindingsReady=" + visible.originalOculusShaderpackSsboBindingsReady()
                + " originalOculusShaderpackImageBindingsReady=" + visible.originalOculusShaderpackImageBindingsReady()
                + " originalOculusShaderpackBlendStateReady=" + visible.originalOculusShaderpackBlendStateReady()
                + " originalOculusShaderpackTaaReady=" + visible.originalOculusShaderpackTaaReady()
                + " originalOculusShaderpackSource=" + visible.originalOculusShaderpackSource()
                + " originalOculusShaderpackFailureReason=" + visible.originalOculusShaderpackFailureReason()
                ...
                + " deprecatedVisiblePreviewRouteAbsent=" + visible.deprecatedVisiblePreviewRouteAbsent()
    ...
    private static String format(ForgeOriginalVoxyMdicCommandGenerationStats status) {
        return "Voxy original MDIC command generation parity: "
                ...
                + " opaquePatchedShaderRequested=" + status.opaquePatchedShaderRequested()
                + " opaquePatchedShaderUsed=" + status.opaquePatchedShaderUsed()
                + " opaquePatchedShaderFallbackUsed=" + status.opaquePatchedShaderFallbackUsed()
                + " translucentPatchedShaderRequested=" + status.translucentPatchedShaderRequested()
                + " translucentPatchedShaderUsed=" + status.translucentPatchedShaderUsed()
                + " translucentPatchedShaderFallbackUsed=" + status.translucentPatchedShaderFallbackUsed()
