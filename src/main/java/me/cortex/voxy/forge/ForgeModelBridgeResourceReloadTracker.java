...
final class ForgeModelBridgeResourceReloadTracker {
    ...
    ForgeModelBridgeResourceReloadStats simulateReload(String reason) {
        ...
        this.instance.getModelSampleSet().markStale("resource-reload-simulated");
        ...
        this.instance.getModelAtlasSampleSetUploader().markStale("resource-reload-simulated");
        this.instance.getFormalShaderInputBridge().markStale("resource-reload-simulated");
