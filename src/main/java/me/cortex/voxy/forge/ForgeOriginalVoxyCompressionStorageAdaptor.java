...
final class ForgeOriginalVoxyCompressionStorageAdaptor extends StorageBackend {
    private final StorageCompressor compressor;
    private final StorageBackend delegate;

    ForgeOriginalVoxyCompressionStorageAdaptor(StorageCompressor compressor, StorageBackend delegate) {
