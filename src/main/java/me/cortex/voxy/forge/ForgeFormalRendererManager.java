...
final class ForgeFormalRendererManager {
    ...
    private static final List<ForgeFormalRendererBlocker> BLOCKERS = List.of(
            ...
            new ForgeFormalRendererBlocker("P1", "P1_FORMAL_COMMAND_GENERATION_MISSING", "Formal command generation missing", "K2 separates formal MDIC-side ownership from debug command buffers, but no formal command generation fills those resources yet.", "Add formal command generation after visibility and model-id geometry ownership are ready.", false),
