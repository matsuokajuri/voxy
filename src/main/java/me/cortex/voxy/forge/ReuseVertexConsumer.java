...
final class ReuseVertexConsumer implements VertexConsumer {
    ...
    ReuseVertexConsumer(int globalOrMetadata) {
        this.globalOrMetadata = globalOrMetadata;
        this.reset();
    }

    ReuseVertexConsumer setDefaultMeta(int meta) {
    ...
    ReuseVertexConsumer quad(BakedQuad quad, boolean forceSolid) {
        throw new IllegalStateException("render-layer-required-for-original-voxy-quad-material");
    }

    ReuseVertexConsumer quad(BakedQuad quad, net.minecraft.client.renderer.RenderType renderType, boolean forceSolid) {
