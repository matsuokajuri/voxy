...
final class UploadStream extends TrackedObject {
    ...
    private UploadStream(long size) {
        ...
        GlDebug.buffer("UploadStream", this.uploadBufferId);
    ...
    static UploadStream instance() {
        if (instance == null) {
            instance = new UploadStream(DEFAULT_SIZE);
        }
        return instance;
    }
